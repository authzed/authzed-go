...
func (m *WatchResourcesRequest) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *PermissionUpdate) CloneVT() *PermissionUpdate {
	...
	r := &PermissionUpdate{
		Relation:          m.Relation,
		UpdatedPermission: m.UpdatedPermission,
	}
...
func (m *PermissionUpdate) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *WatchResourcesResponse) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *PermissionUpdate) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.UpdatedPermission != 0 {
		i = encodeVarint(dAtA, i, uint64(m.UpdatedPermission))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Relation) > 0 {
...
func (m *PermissionUpdate) SizeVT() (n int) {
	...
	if m.UpdatedPermission != 0 {
		n += 1 + sov(uint64(m.UpdatedPermission))
	}
	n += len(m.unknownFields)
	return n
}
