...
func (m *ReadSchemaRequest) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *ReadSchemaResponse) CloneVT() *ReadSchemaResponse {
	...
	r := &ReadSchemaResponse{
		ComputedDefinitionsRevision: m.ComputedDefinitionsRevision,
	}
...
func (m *ReadSchemaResponse) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *WriteSchemaRequest) CloneVT() *WriteSchemaRequest {
	...
	r := &WriteSchemaRequest{
		Schema:                                  m.Schema,
		OptionalDefinitionsRevisionPrecondition: m.OptionalDefinitionsRevisionPrecondition,
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *WriteSchemaRequest) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *WriteSchemaResponse) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *ReadSchemaRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ObjectDefinitionsNames) > 0 {
		for iNdEx := len(m.ObjectDefinitionsNames) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarint(dAtA, i, uint64(len(m.ObjectDefinitionsNames[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *ReadSchemaResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ComputedDefinitionsRevision) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.ComputedDefinitionsRevision)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ObjectDefinitions) > 0 {
		for iNdEx := len(m.ObjectDefinitions) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarint(dAtA, i, uint64(len(m.ObjectDefinitions[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *WriteSchemaRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.OptionalDefinitionsRevisionPrecondition) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.OptionalDefinitionsRevisionPrecondition)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Schema) > 0 {
