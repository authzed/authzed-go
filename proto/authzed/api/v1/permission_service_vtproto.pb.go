...
func (m *ReadBulkRelationshipsResponseItem) CloneVT() *ReadBulkRelationshipsResponseItem {
	...
	r.Relationships = m.Relationships.CloneVT()
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (this *ReadBulkRelationshipsResponseItem) EqualVT(that *ReadBulkRelationshipsResponseItem) bool {
	...
	if !this.Relationships.EqualVT(that.Relationships) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (m *ReadBulkRelationshipsResponseItem) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Relationships != nil {
		size, err := m.Relationships.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *ReadBulkRelationshipsResponseItem) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.Relationships.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
