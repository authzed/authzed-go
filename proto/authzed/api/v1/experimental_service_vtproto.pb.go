...
func (m *BulkImportRelationshipsRequest) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *BulkImportRelationshipsResponse) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *BulkExportRelationshipsRequest) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *BulkExportRelationshipsResponse) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
