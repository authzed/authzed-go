...
const file_authzed_api_v1_experimental_service_proto_rawDesc = "" +
	"\n" +
	")authzed/api/v1/experimental_service.proto\x12\x0eauthzed.api.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x17google/rpc/status.proto\x1a\x19authzed/api/v1/core.proto\x1a'authzed/api/v1/permission_service.proto\"\xcf\x01\n" +
	".ExperimentalRegisterRelationshipCounterRequest\x12>\n" +
	"\x04name\x18\x01 \x01(\tB*\xfaB'r%(@2!^([a-z][a-z0-9_]{1,62}[a-z0-9])?$R\x04name\x12]\n" +
	"\x13relationship_filter\x18\x02 \x01(\v2\".authzed.api.v1.RelationshipFilterB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x12relationshipFilter\"1\n" +
	"/ExperimentalRegisterRelationshipCounterResponse\"g\n" +
	"%ExperimentalCountRelationshipsRequest\x12>\n" +
	"\x04name\x18\x01 \x01(\tB*\xfaB'r%(@2!^([a-z][a-z0-9_]{1,62}[a-z0-9])?$R\x04name\"\xca\x01\n" +
	...
	"\aread_at\x18\x02 \x01(\v2\x18.authzed.api.v1.ZedTokenB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x06readAt\"r\n" +
	"0ExperimentalUnregisterRelationshipCounterRequest\x12>\n" +
	"\x04name\x18\x01 \x01(\tB*\xfaB'r%(@2!^([a-z][a-z0-9_]{1,62}[a-z0-9])?$R\x04name\"3\n" +
	...
	"\x92\x01\a\"\x05\x8a\x01\x02\x10\x01\x18\x01R\x05items\"\xb6\x02\n" +
	"\x1eBulkCheckPermissionRequestItem\x12E\n" +
	...
	"\acontext\x18\x04 \x01(\v2\x17.google.protobuf.StructB\b\xfaB\x05\x8a\x01\x02\x10\x00R\acontext\"\xae\x01\n" +
	"\x1bBulkCheckPermissionResponse\x12A\n" +
	"\n" +
	"checked_at\x18\x01 \x01(\v2\x18.authzed.api.v1.ZedTokenB\b\xfaB\x05\x8a\x01\x02\x10\x00R\tcheckedAt\x12L\n" +
	...
	"\n" +
	"\bresponse\"\xea\x01\n" +
	"\x1fBulkCheckPermissionResponseItem\x12j\n" +
	...
	"\x13partial_caveat_info\x18\x02 \x01(\v2!.authzed.api.v1.PartialCaveatInfoB\b\xfaB\x05\x8a\x01\x02\x10\x00R\x11partialCaveatInfo\"s\n" +
