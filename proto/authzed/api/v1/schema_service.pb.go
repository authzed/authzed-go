...
const file_authzed_api_v1_schema_service_proto_rawDesc = "" +
	"\n" +
	"#authzed/api/v1/schema_service.proto\x12\x0eauthzed.api.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\x1a\x19authzed/api/v1/core.proto\x1a'authzed/api/v1/permission_service.proto\"\x13\n" +
	"\x11ReadSchemaRequest\"r\n" +
	"\x12ReadSchemaResponse\x12\x1f\n" +
	"\vschema_text\x18\x01 \x01(\tR\n" +
	"schemaText\x12;\n" +
	"\aread_at\x18\x02 \x01(\v2\x18.authzed.api.v1.ZedTokenB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x06readAt\"8\n" +
	"\x12WriteSchemaRequest\x12\"\n" +
	"\x06schema\x18\x01 \x01(\tB\n" +
	"\xfaB\ar\x05(\x80\x80\x80\x02R\x06schema\"X\n" +
	"\x13WriteSchemaResponse\x12A\n" +
	"\n" +
	"written_at\x18\x01 \x01(\v2\x18.authzed.api.v1.ZedTokenB\b\xfaB\x05\x8a\x01\x02\x10\x01R\twrittenAt\"\xa8\x01\n" +
