...
const file_authzed_api_v1_permission_service_proto_rawDesc = "" +
	"\n" +
	"'authzed/api/v1/permission_service.proto\x12\x0eauthzed.api.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/rpc/status.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17validate/validate.proto\x1a\x19authzed/api/v1/core.proto\x1a\x1aauthzed/api/v1/debug.proto\"\x9c\x02\n" +
	"\vConsistency\x124\n" +
	"\x10minimize_latency\x18\x01 \x01(\bB\a\xfaB\x04j\x02\b\x01H\x00R\x0fminimizeLatency\x12E\n" +
	"\x11at_least_as_fresh\x18\x02 \x01(\v2\x18.authzed.api.v1.ZedTokenH\x00R\x0eatLeastAsFresh\x12F\n" +
	"\x11at_exact_snapshot\x18\x03 \x01(\v2\x18.authzed.api.v1.ZedTokenH\x00R\x0fatExactSnapshot\x124\n" +
	"\x10fully_consistent\x18\x04 \x01(\bB\a\xfaB\x04j\x02\b\x01H\x00R\x0ffullyConsistentB\x12\n" +
	"\vrequirement\x12\x03\xf8B\x01\"\xf5\x03\n" +
	...
	"\x11optional_relation\x18\x03 \x01(\tB*\xfaB'r%(@2!^([a-z][a-z0-9_]{1,62}[a-z0-9])?$R\x10optionalRelation\x12U\n" +
	"\x17optional_subject_filter\x18\x04 \x01(\v2\x1d.authzed.api.v1.SubjectFilterR\x15optionalSubjectFilter\"\x8d\x03\n" +
	"\rSubjectFilter\x12k\n" +
	"\fsubject_type\x18\x01 \x01(\tBH\xfaBErC(\x80\x012>^([a-z][a-z0-9_]{1,61}[a-z0-9]/)*[a-z][a-z0-9_]{1,62}[a-z0-9]$R\vsubjectType\x12Z\n" +
	"\x13optional_subject_id\x18\x02 \x01(\tB*\xfaB'r%(\x80\b2 ^(([a-zA-Z0-9/_|\\-=+]{1,})|\\*)?$R\x11optionalSubjectId\x12Y\n" +
	"\x11optional_relation\x18\x03 \x01(\v2,.authzed.api.v1.SubjectFilter.RelationFilterR\x10optionalRelation\x1aX\n" +
	"\x0eRelationFilter\x12F\n" +
	"\brelation\x18\x01 \x01(\tB*\xfaB'r%(@2!^([a-z][a-z0-9_]{1,62}[a-z0-9])?$R\brelation\"\xd9\x02\n" +
	"\x18ReadRelationshipsRequest\x12=\n" +
	"\vconsistency\x18\x01 \x01(\v2\x1b.authzed.api.v1.ConsistencyR\vconsistency\x12]\n" +
	"\x13relationship_filter\x18\x02 \x01(\v2\".authzed.api.v1.RelationshipFilterB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x12relationshipFilter\x12.\n" +
	"\x0eoptional_limit\x18\x03 \x01(\rB\a\xfaB\x04*\x02(\x00R\roptionalLimit\x12?\n" +
	"\x0foptional_cursor\x18\x04 \x01(\v2\x16.authzed.api.v1.CursorR\x0eoptionalCursor\x12.\n" +
	"\x13include_object_data\x18\x05 \x01(\bR\x11includeObjectData\"\x94\x03\n" +
	"\x19ReadRelationshipsResponse\x12;\n" +
	"\aread_at\x18\x01 \x01(\v2\x18.authzed.api.v1.ZedTokenB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x06readAt\x12J\n" +
	"\frelationship\x18\x02 \x01(\v2\x1c.authzed.api.v1.RelationshipB\b\xfaB\x05\x8a\x01\x02\x10\x01R\frelationship\x12F\n" +
	"\x13after_result_cursor\x18\x03 \x01(\v2\x16.authzed.api.v1.CursorR\x11afterResultCursor\x12S\n" +
	"\x14resource_object_data\x18\x04 \x01(\v2\x17.google.protobuf.StructB\b\xfaB\x05\x8a\x01\x02\x10\x00R\x12resourceObjectData\x12Q\n" +
	"\x13subject_object_data\x18\x05 \x01(\v2\x17.google.protobuf.StructB\b\xfaB\x05\x8a\x01\x02\x10\x00R\x11subjectObjectData\"\x86\x02\n" +
	"\fPrecondition\x12P\n" +
	"\toperation\x18\x01 \x01(\x0e2&.authzed.api.v1.Precondition.OperationB\n" +
	"\xfaB\a\x82\x01\x04\x10\x01 \x00R\toperation\x12D\n" +
	"\x06filter\x18\x02 \x01(\v2\".authzed.api.v1.RelationshipFilterB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x06filter\"^\n" +
	"\tOperation\x12\x19\n" +
	...
	"\x92\x01\a\"\x05\x8a\x01\x02\x10\x01R\x15optionalPreconditions\x12e\n" +
	"\x1doptional_transaction_metadata\x18\x03 \x01(\v2\x17.google.protobuf.StructB\b\xfaB\x05\x8a\x01\x02\x10\x00R\x1boptionalTransactionMetadata\"U\n" +
	"\x1aWriteRelationshipsResponse\x127\n" +
	"\n" +
	"written_at\x18\x01 \x01(\v2\x18.authzed.api.v1.ZedTokenR\twrittenAt\"\xbf\x03\n" +
	"\x1aDeleteRelationshipsRequest\x12]\n" +
	"\x13relationship_filter\x18\x01 \x01(\v2\".authzed.api.v1.RelationshipFilterB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x12relationshipFilter\x12b\n" +
	"\x16optional_preconditions\x18\x02 \x03(\v2\x1c.authzed.api.v1.PreconditionB\r\xfaB\n" +
	"\x92\x01\a\"\x05\x8a\x01\x02\x10\x01R\x15optionalPreconditions\x12.\n" +
	"\x0eoptional_limit\x18\x03 \x01(\rB\a\xfaB\x04*\x02(\x00R\roptionalLimit\x12G\n" +
	" optional_allow_partial_deletions\x18\x04 \x01(\bR\x1doptionalAllowPartialDeletions\x12e\n" +
	"\x1doptional_transaction_metadata\x18\x05 \x01(\v2\x17.google.protobuf.StructB\b\xfaB\x05\x8a\x01\x02\x10\x00R\x1boptionalTransactionMetadata\"\xf7\x02\n" +
	...
	"\x19DELETION_PROGRESS_PARTIAL\x10\x02\"\x90\x03\n" +
	"\x16CheckPermissionRequest\x12=\n" +
	"\vconsistency\x18\x01 \x01(\v2\x1b.authzed.api.v1.ConsistencyR\vconsistency\x12E\n" +
	"\bresource\x18\x02 \x01(\v2\x1f.authzed.api.v1.ObjectReferenceB\b\xfaB\x05\x8a\x01\x02\x10\x01R\bresource\x12J\n" +
	"\n" +
	"permission\x18\x03 \x01(\tB*\xfaB'r%(@2!^([a-z][a-z0-9_]{1,62}[a-z0-9])?$R\n" +
	"permission\x12D\n" +
	"\asubject\x18\x04 \x01(\v2 .authzed.api.v1.SubjectReferenceB\b\xfaB\x05\x8a\x01\x02\x10\x01R\asubject\x12;\n" +
	"\acontext\x18\x05 \x01(\v2\x17.google.protobuf.StructB\b\xfaB\x05\x8a\x01\x02\x10\x00R\acontext\x12!\n" +
	"\fwith_tracing\x18\x06 \x01(\bR\vwithTracing\"\xd7\x04\n" +
	"\x17CheckPermissionResponse\x12A\n" +
	"\n" +
	"checked_at\x18\x01 \x01(\v2\x18.authzed.api.v1.ZedTokenB\b\xfaB\x05\x8a\x01\x02\x10\x00R\tcheckedAt\x12j\n" +
	"\x0epermissionship\x18\x02 \x01(\x0e26.authzed.api.v1.CheckPermissionResponse.PermissionshipB\n" +
	"\xfaB\a\x82\x01\x04\x10\x01 \x00R\x0epermissionship\x12[\n" +
	"\x13partial_caveat_info\x18\x03 \x01(\v2!.authzed.api.v1.PartialCaveatInfoB\b\xfaB\x05\x8a\x01\x02\x10\x00R\x11partialCaveatInfo\x12A\n" +
	...
	"\fwith_tracing\x18\x03 \x01(\bR\vwithTracing\"\xb7\x02\n" +
	"\x1fCheckBulkPermissionsRequestItem\x12E\n" +
	"\bresource\x18\x01 \x01(\v2\x1f.authzed.api.v1.ObjectReferenceB\b\xfaB\x05\x8a\x01\x02\x10\x01R\bresource\x12J\n" +
	"\n" +
	"permission\x18\x02 \x01(\tB*\xfaB'r%(@2!^([a-z][a-z0-9_]{1,62}[a-z0-9])?$R\n" +
	"permission\x12D\n" +
	"\asubject\x18\x03 \x01(\v2 .authzed.api.v1.SubjectReferenceB\b\xfaB\x05\x8a\x01\x02\x10\x01R\asubject\x12;\n" +
	"\acontext\x18\x04 \x01(\v2\x17.google.protobuf.StructB\b\xfaB\x05\x8a\x01\x02\x10\x00R\acontext\"\xb0\x01\n" +
	"\x1cCheckBulkPermissionsResponse\x12A\n" +
	"\n" +
	"checked_at\x18\x01 \x01(\v2\x18.authzed.api.v1.ZedTokenB\b\xfaB\x05\x8a\x01\x02\x10\x00R\tcheckedAt\x12M\n" +
	...
	"\x0epermissionship\x18\x01 \x01(\x0e26.authzed.api.v1.CheckPermissionResponse.PermissionshipB\n" +
	"\xfaB\a\x82\x01\x04\x10\x01 \x00R\x0epermissionship\x12[\n" +
	"\x13partial_caveat_info\x18\x02 \x01(\v2!.authzed.api.v1.PartialCaveatInfoB\b\xfaB\x05\x8a\x01\x02\x10\x00R\x11partialCaveatInfo\x12A\n" +
	...
	"expandedAt\x12G\n" +
	"\ttree_root\x18\x02 \x01(\v2*.authzed.api.v1.PermissionRelationshipTreeR\btreeRoot\"\xc0\x04\n" +
	"\x16LookupResourcesRequest\x12=\n" +
	"\vconsistency\x18\x01 \x01(\v2\x1b.authzed.api.v1.ConsistencyR\vconsistency\x12z\n" +
	"\x14resource_object_type\x18\x02 \x01(\tBH\xfaBErC(\x80\x012>^([a-z][a-z0-9_]{1,61}[a-z0-9]/)*[a-z][a-z0-9_]{1,62}[a-z0-9]$R\x12resourceObjectType\x12G\n" +
	"\n" +
	"permission\x18\x03 \x01(\tB'\xfaB$r\"(@2\x1e^[a-z][a-z0-9_]{1,62}[a-z0-9]$R\n" +
	"permission\x12D\n" +
	"\asubject\x18\x04 \x01(\v2 .authzed.api.v1.SubjectReferenceB\b\xfaB\x05\x8a\x01\x02\x10\x01R\asubject\x12;\n" +
	"\acontext\x18\x05 \x01(\v2\x17.google.protobuf.StructB\b\xfaB\x05\x8a\x01\x02\x10\x00R\acontext\x12.\n" +
	"\x0eoptional_limit\x18\x06 \x01(\rB\a\xfaB\x04*\x02(\x00R\roptionalLimit\x12?\n" +
	"\x0foptional_cursor\x18\a \x01(\v2\x16.authzed.api.v1.CursorR\x0eoptionalCursor\x12.\n" +
	"\x13include_object_data\x18\b \x01(\bR\x11includeObjectData\"\xd7\x03\n" +
	...
	"\x0epermissionship\x18\x03 \x01(\x0e2$.authzed.api.v1.LookupPermissionshipB\n" +
	"\xfaB\a\x82\x01\x04\x10\x01 \x00R\x0epermissionship\x12[\n" +
	"\x13partial_caveat_info\x18\x04 \x01(\v2!.authzed.api.v1.PartialCaveatInfoB\b\xfaB\x05\x8a\x01\x02\x10\x00R\x11partialCaveatInfo\x12F\n" +
	"\x13after_result_cursor\x18\x05 \x01(\v2\x16.authzed.api.v1.CursorR\x11afterResultCursor\x12S\n" +
	"\x14resource_object_data\x18\x06 \x01(\v2\x17.google.protobuf.StructB\b\xfaB\x05\x8a\x01\x02\x10\x00R\x12resourceObjectData\"\x9a\a\n" +
	...
	"permission\x18\x03 \x01(\tB*\xfaB'r%(@2!^([a-z][a-z0-9_]{1,62}[a-z0-9])?$R\n" +
	"permission\x12x\n" +
	"\x13subject_object_type\x18\x04 \x01(\tBH\xfaBErC(\x80\x012>^([a-z][a-z0-9_]{1,61}[a-z0-9]/)*[a-z][a-z0-9_]{1,62}[a-z0-9]$R\x11subjectObjectType\x12f\n" +
	"\x19optional_subject_relation\x18\x05 \x01(\tB*\xfaB'r%(@2!^([a-z][a-z0-9_]{1,62}[a-z0-9])?$R\x17optionalSubjectRelation\x12;\n" +
	"\acontext\x18\x06 \x01(\v2\x17.google.protobuf.StructB\b\xfaB\x05\x8a\x01\x02\x10\x00R\acontext\x12?\n" +
	"\x17optional_concrete_limit\x18\a \x01(\rB\a\xfaB\x04*\x02(\x00R\x15optionalConcreteLimit\x12?\n" +
	"\x0foptional_cursor\x18\b \x01(\v2\x16.authzed.api.v1.CursorR\x0eoptionalCursor\x12]\n" +
	"\x0fwildcard_option\x18\t \x01(\x0e24.authzed.api.v1.LookupSubjectsRequest.WildcardOptionR\x0ewildcardOption\x12.\n" +
	"\x13include_object_data\x18\n" +
	" \x01(\bR\x11includeObjectData\"\x7f\n" +
	...
	"\x14excluded_subject_ids\x18\x03 \x03(\tB\x02\x18\x01R\x12excludedSubjectIds\x12Z\n" +
	"\x0epermissionship\x18\x04 \x01(\x0e2$.authzed.api.v1.LookupPermissionshipB\f\xfaB\a\x82\x01\x04\x10\x01 \x00\x18\x01R\x0epermissionship\x12]\n" +
	"\x13partial_caveat_info\x18\x05 \x01(\v2!.authzed.api.v1.PartialCaveatInfoB\n" +
	"\xfaB\x05\x8a\x01\x02\x10\x00\x18\x01R\x11partialCaveatInfo\x129\n" +
	...
	"\x13after_result_cursor\x18\b \x01(\v2\x16.authzed.api.v1.CursorR\x11afterResultCursor\"\xc7\x02\n" +
	"\x0fResolvedSubject\x12*\n" +
	"\x11subject_object_id\x18\x01 \x01(\tR\x0fsubjectObjectId\x12X\n" +
	"\x0epermissionship\x18\x02 \x01(\x0e2$.authzed.api.v1.LookupPermissionshipB\n" +
	"\xfaB\a\x82\x01\x04\x10\x01 \x00R\x0epermissionship\x12[\n" +
	"\x13partial_caveat_info\x18\x03 \x01(\v2!.authzed.api.v1.PartialCaveatInfoB\b\xfaB\x05\x8a\x01\x02\x10\x00R\x11partialCaveatInfo\x12Q\n" +
	"\x13subject_object_data\x18\x04 \x01(\v2\x17.google.protobuf.StructB\b\xfaB\x05\x8a\x01\x02\x10\x00R\x11subjectObjectData\"s\n" +
	...
	"\n" +
	"num_loaded\x18\x01 \x01(\x04R\tnumLoaded\"\xe6\x02\n" +
	"\x1eExportBulkRelationshipsRequest\x12=\n" +
	"\vconsistency\x18\x01 \x01(\v2\x1b.authzed.api.v1.ConsistencyR\vconsistency\x12.\n" +
	"\x0eoptional_limit\x18\x02 \x01(\rB\a\xfaB\x04*\x02(\x00R\roptionalLimit\x12?\n" +
	"\x0foptional_cursor\x18\x03 \x01(\v2\x16.authzed.api.v1.CursorR\x0eoptionalCursor\x12d\n" +
	"\x1coptional_relationship_filter\x18\x04 \x01(\v2\".authzed.api.v1.RelationshipFilterR\x1aoptionalRelationshipFilter\x12.\n" +
	"\x13include_object_data\x18\x05 \x01(\bR\x11includeObjectData\"\xad\x01\n" +
