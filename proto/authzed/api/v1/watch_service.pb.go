...
const file_authzed_api_v1_watch_service_proto_rawDesc = "" +
	"\n" +
	"\"authzed/api/v1/watch_service.proto\x12\x0eauthzed.api.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x17validate/validate.proto\x1a\x19authzed/api/v1/core.proto\x1a'authzed/api/v1/permission_service.proto\"\x99\x03\n" +
	"\fWatchRequest\x12\x83\x01\n" +
	"\x15optional_object_types\x18\x01 \x03(\tBO\xfaBL\x92\x01I\b\x00\"ErC(\x80\x012>^([a-z][a-z0-9_]{1,62}[a-z0-9]/)*[a-z][a-z0-9_]{1,62}[a-z0-9]$R\x13optionalObjectTypes\x12L\n" +
