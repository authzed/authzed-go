...
var file_authzed_api_materialize_v0_watchpermissions_proto_goTypes = []interface{}{
...
func file_authzed_api_materialize_v0_watchpermissions_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_authzed_api_materialize_v0_watchpermissions_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_authzed_api_materialize_v0_watchpermissions_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WatchedPermission); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_authzed_api_materialize_v0_watchpermissions_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_authzed_api_materialize_v0_watchpermissions_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_authzed_api_materialize_v0_watchpermissions_proto_msgTypes[2].OneofWrappers = []interface{}{
