...
type WatchPermissionsServiceClient interface {
	...
	WatchPermissions(ctx context.Context, in *WatchPermissionsRequest, opts ...grpc.CallOption) (WatchPermissionsService_WatchPermissionsClient, error)
}
...
func (c *watchPermissionsServiceClient) WatchPermissions(ctx context.Context, in *WatchPermissionsRequest, opts ...grpc.CallOption) (WatchPermissionsService_WatchPermissionsClient, error) {
	...
	x := &watchPermissionsServiceWatchPermissionsClient{ClientStream: stream}
...
type WatchPermissionsService_WatchPermissionsClient interface {
	Recv() (*WatchPermissionsResponse, error)
	grpc.ClientStream
}

type watchPermissionsServiceWatchPermissionsClient struct {
	grpc.ClientStream
}

func (x *watchPermissionsServiceWatchPermissionsClient) Recv() (*WatchPermissionsResponse, error) {
...
type WatchPermissionsServiceServer interface {
	...
	// is only recommended when performing the set intersections of WatchPermissionSets in the client side is not viable
	// or there is a strict application requirement to use consume the computed permissions.
	WatchPermissions(*WatchPermissionsRequest, WatchPermissionsService_WatchPermissionsServer) error
...
func (UnimplementedWatchPermissionsServiceServer) WatchPermissions(*WatchPermissionsRequest, WatchPermissionsService_WatchPermissionsServer) error {
...
func _WatchPermissionsService_WatchPermissions_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(WatchPermissionsServiceServer).WatchPermissions(m, &watchPermissionsServiceWatchPermissionsServer{ServerStream: stream})
}

type WatchPermissionsService_WatchPermissionsServer interface {
	Send(*WatchPermissionsResponse) error
	grpc.ServerStream
}

type watchPermissionsServiceWatchPermissionsServer struct {
	grpc.ServerStream
}

func (x *watchPermissionsServiceWatchPermissionsServer) Send(m *WatchPermissionsResponse) error {
